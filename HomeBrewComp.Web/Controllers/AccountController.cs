...
using HomeBrewComp.Web.Authentication;
using HomeBrewComp.Domain;

namespace HomeBrewComp.Web.Controllers
{
    [Authorize]
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                // TODO: Add these fields to the registration screen.
                var user = new User(model.UserName, null, null, null, null, null, null, null);
